...
/***/ (function(module, exports, __webpack_require__) {
	...
	window.$ReactUpload = function (el, destPath) {
	  var injElement = document.getElementById(el);

	  if (!destPath) {
	    throw new Error('Error, React Upload destPath parameter cannot be null.');
	  }

	  _reactDom2.default.render(_react2.default.createElement(_dropZone2.default, { url: destPath }), injElement);
	}; /**
	   * React-Upload
	   *
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DropZone = function (_React$Component) {
	  ...
	  function DropZone(props) {
	    ...
	    if (!_this.props.url) _this.props.url = "";

	    _this.defaultUploadOptions = {};
	    ...
	    _this.resetUploadState = _this.resetUploadState.bind(_this);
	  ...
	  _createClass(DropZone, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      var EnteringDropZone = function EnteringDropZone(e) {
	        e.currentTarget.classList.add('Drop-Zone-Enter');
	      };

	      var LeavingDropZone = function LeavingDropZone(e) {
	        e.currentTarget.classList.remove('Drop-Zone-Enter');
	      };

	      // Call newFile on drop
	      var DropFile = function DropFile(e) {
	        if (!!e.dataTransfer) {
	          if (e.dataTransfer.files.length > 0) that.newFile(e.dataTransfer.files);
	        }
	    ...
	    key: 'openBrowser',
	    value: function openBrowser(incoming_file) {
	      incoming_file.click();
	    }
	    ...
	    key: 'newFile',
	    value: function newFile(files) {
	      var _this2 = this;

	      if (files.length > 0) {
	        this.updateSelectedFile(files[0]);
	        this.sendFile(files[0]).then(function () {
	    ...
	    value: function sendFile(file) {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        for (var k in that.defaultUploadOptions || {}) {
	          that.currentXHR.setRequestHeader(k, that.defaultUploadOptions[k]);
	        }

	        that.currentXHR.onload = function (e) {
	          return resolve(e.target);
	        };

	        that.currentXHR.onerror = function (e) {
	          that.stopUpload();
	          reject(e);
	        };

	        that.currentXHR.onabort = function (e) {
	          return that.resetUploadState();
	        };

	        if (that.currentXHR.upload) that.currentXHR.upload.onprogress = function (e) {
	          ...
	          if (!!uploadTime1 && !!uploadTime2) {
	            ...
	            var msTime = (uploadTime2 - uploadTime1) / 1000;

	            if (msTime > 1) {
	              coeff = msTime.toFixed(0);

	              if (!isNaN(coeff)) coeff = parseInt(coeff, 10);
	    ...
	    value: function updateSelectedFile(file) {
	      this.setState({
	        filename: file.name,
	        size: file.size
	      });
	    ...
	    key: 'updateProgress',
	    value: function updateProgress(progress, rate) {
	      this.setState({
	        progress: progress,
	        rate: rate
	      });
	    ...
	    value: function render() {
	      ...
	      var _state = this.state,
	          ...
	          isUploaded = _state.isUploaded,
	          rate = _state.rate,
	          progress = _state.progress;

	      var actionBtn = null;

	      if (isUploading) actionBtn = _react2.default.createElement(
	        'button',
	        { className: 'btn btn-large btn-cancel', onClick: function onClick(e) {
	            return _this3.cancelUpload();
	          } },
	        ' ',
	        _react2.default.createElement('i', { className: 'ion ion-ios-close-outline' }),
	        ' Cancel Upload'
	      );else actionBtn = _react2.default.createElement(
	        'button',
	        { className: 'btn btn-large btn-upload', onClick: function onClick(e) {
	            return _this3.openBrowser(_this3.refs.incoming_file);
	          } },
	        ' ',
	        _react2.default.createElement('i', { className: 'ion ion-ios-upload-outline' }),
	        ' Pick a file'
	      );
	      ...
	      if (filename !== "" && isUploading) {
	        currentFile = _react2.default.createElement(
	          'div',
	          { className: 'Dropped-File' },
	          _react2.default.createElement('i', { className: 'ion ion-document' }),
	          ' ',
	          filename
	        );
	      }
	      ...
	      var progressZone = null;

	      if (isUploading) {
	        progressZone = _react2.default.createElement(
	          'div',
	          { className: 'Drop-Progress container-fluid' },
	          _react2.default.createElement(
	            'div',
	            { className: 'progress' },
	            _react2.default.createElement('div', { className: 'progress-bar bg-info', role: 'progressbar',
	              style: { width: progress + '%' }, 'aria-valuenow': progress, 'aria-valuemin': '0', 'aria-valuemax': '100' }),
	            _react2.default.createElement(
	              'div',
	              { className: 'progress-info' },
	              progress.toFixed(0) + '% (' + rate.toFixed(0) + this.rate_unit + ')'
	            )
	          ),
	          _react2.default.createElement(
	            'h5',
	            { className: 'upload-infos' },
	            _react2.default.createElement('i', { className: 'ion ion-load-c upload-icon spin' }),
	            ' ',
	            "Uploading..."
	          )
	        );
	      } else {
	        progressZone = _react2.default.createElement('div', null);
	      }
	      ...
	      if (isUploaded) {
	        progressZone = _react2.default.createElement(
	          'div',
	          { className: 'Drop-Progress container-fluid' },
	          _react2.default.createElement('i', { className: 'ion ion-checkmark' }),
	          ' ',
	          "Upload Finished"
	        );
	      }
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'Drop-Zone', ref: 'drop_zone' },
	        _react2.default.createElement(
	          'div',
	          { className: 'Drop-Content' },
	          currentFile,
	          _react2.default.createElement('input', { type: 'file', ref: 'incoming_file', onChange: function onChange(e) {
	              return _this3.newFile(e.target.files);
